...
const Header = ({companies}) => {
    return (
        <div>
            <h1>Choose the top 5 companies that should be sent to space in the very car model they make</h1>
            ...
            <h3>You can add some companies and delete, just choose 5 :  ({companies.length})</h3>
            <Add />
